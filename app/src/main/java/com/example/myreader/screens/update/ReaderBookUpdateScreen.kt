...
package com.example.myreader.screens.update
...
import com.example.myreader.screens.home.HomeScreenViewModel
import com.example.myreader.utils.formatDate
        ...
        Surface(modifier = Modifier
            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    ShowSimpleForm(book = viewModel.data.value.data?.first()!!, navController)
    ...
    Row() {
        ...
        if (bookInfo.data != null) {
            Column(modifier = Modifier.padding(4.dp),
                ...
                CardListItem(book = bookInfo.data!!.first(), onPressDetails = {})
